...
const companyNameInput = <HTMLInputElement>document.getElementById('company');
const emailInput = <HTMLInputElement>document.querySelector('input[placeholder=" Your Email"]');
const postcodeInput = <HTMLInputElement>document.querySelector('input[placeholder="Postcode"]');
const companyNameError = <HTMLSpanElement>document.getElementById('companyNameError');
const emailError = <HTMLSpanElement>document.getElementById('emailError');
const postcodeError = <HTMLSpanElement>document.getElementById('postcodeError');
